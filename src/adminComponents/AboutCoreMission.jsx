...
const AboutCoreMission = () => {
  ...
  const [featureToEdit, setFeatureToEdit] = useState(null); // State to hold the data currently being edited
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 lg:ml-64 transition-all duration-300">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex justify-between items-center pb-4 border-b border-gray-200">
              ...
              <button className="flex items-center space-x-2 px-4 py-2 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 transition shadow-md">
              ...
              {data.map((feature) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Edit button positioned with better styling */}
                    <button
                      onClick={() => handleEditClick(feature)}
                      className="absolute top-3 right-3 p-2 text-indigo-500 rounded-full bg-white/70 hover:bg-indigo-100 hover:text-indigo-700 transition opacity-0 group-hover:opacity-100 focus:opacity-100"
            ...
            <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-center p-5 border-b border-gray-200 bg-indigo-50 rounded-t-xl">
                  <h2 className="text-xl font-bold text-gray-800 flex items-center"></h2>
                  <button
