...
const galleryItems = [
  { id: 1, src: 'https://partner.digitalclassworld.com/storage/homepage/gallary/68ea3d706319d.jpg', alt: 'Students collaborating in a modern classroom', caption: 'Interactive Learning Session' },
  { id: 2, src: 'https://partner.digitalclassworld.com/storage/homepage/gallary/68ea3d8f0db2c.jpg', alt: 'Professor lecturing in a large hall', caption: 'Main Lecture Hall Facility' },
  { id: 3, src: 'https://partner.digitalclassworld.com/storage/homepage/gallary/68ea3dd42b66e.jpg', alt: 'Students cheering during graduation', caption: 'Celebrating Success: Graduation' },
  { id: 4, src: 'https://partner.digitalclassworld.com/storage/homepage/gallary/68ea433e19b12.jpg', alt: 'Practical workshop in a computer lab', caption: 'Hands-on Lab Training' },
  { id: 5, src: 'https://partner.digitalclassworld.com/storage/homepage/gallary/68ea448e156a5.jpeg', alt: 'Students relaxing in the campus courtyard', caption: 'Vibrant Campus Life' },
  { id: 6, src: 'https://partner.digitalclassworld.com/storage/homepage/gallary/68ea47584273e.jpg', alt: 'A bright, quiet academy library', caption: 'Quiet Study Zone' },
];
...
const Gallery = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-blue-50 transition duration-500">
      ...
      <p className="text-xl text-center text-gray-400 mb-16 max-w-3xl mx-auto">
        Witness the dynamic environment, cutting-edge facilities, and collaborative energy that fuels future leaders.
      </p>
        ...
        {galleryItems.map((item) => (
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 bg-white/10 backdrop-blur-md p-4 transition duration-300 translate-y-full group-hover:translate-y-0">
                <p className="text-lg font-semibold text-white truncate">{item.caption}</p>
            </div>
